              ...
              fields: [
                {
                  ...
                  fields: [
                    ...
                    },
                    {
                      ...
                      defaultValue: 'none',
                      options: [
                        { label: 'Sin ícono (Por defecto)', value: 'none' },
                        { label: 'Check (✔)', value: 'check' },
                        { label: 'Material / Capas', value: 'layers' },
                        { label: 'Medidas / Tamaño', value: 'ruler' },
                        { label: 'Peso / Báscula', value: 'weight' },
                        { label: 'Resistencia / Escudo', value: 'shield' },
                        { label: 'Agua / Impermeable', value: 'droplets' },
                        { label: 'Batería / Energía', value: 'battery' },
                        { label: 'Tecnología / CPU', value: 'cpu' },
                        { label: 'Conectividad / Wifi', value: 'wifi' },
                        { label: 'Bluetooth', value: 'bluetooth' },
                        { label: 'Garantía / Estrella', value: 'star' },
                        { label: 'Ecológico / Hoja', value: 'leaf' },
                        { label: 'Herramienta / Montaje', value: 'wrench' },
                        { label: 'Prenda / Tela', value: 'shirt' },
                        { label: 'Destacado / Sparkles', value: 'sparkles' },
                      ],
                      admin: { width: '30%' },
                    },
                  ],
